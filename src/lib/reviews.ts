...
export const reviews: Record<string, Review[]> = {
  ...
  'south-campground-zion': [
    { id: 'sz1', author: 'AngelLandingFirst', source: 'The Dyrt', rating: 5, date: '2025-09', text: 'First shuttle at 6am, top of Angels Landing by 8am before the crowds. The canyon walls glowing orange while we had the summit to ourselves. The location of this campground makes that possible.', helpful: 287, verified: true, type: 'positive' },
    { id: 'sz2', author: 'NarrowsNoonSwim', source: 'Campendium', rating: 5, date: '2025-07', text: 'Temperature outside: 104°F. Inside the Narrows slot canyon: 75°F. Waded for 5 hours and it was the best decision of the whole trip. Trailhead is 20 minutes walk from camp.', helpful: 234, verified: true, type: 'positive' },
    { id: 'sz3', author: 'SunsetGlow27ft', source: 'Google', rating: 4, date: '2025-06', text: 'Pulled in right at the 27ft limit. Tight but manageable. The canyon glowing at sunset from inside the campground was worth every inch of careful maneuvering.', helpful: 156, verified: true, type: 'mixed' },
    { id: 'sz4', author: 'SixMonthMiss', source: 'Recreation.gov', rating: 3, date: '2024-08', text: 'Missed the 6-month booking window by 2 minutes. Set a cancellation alert and got a site 3 weeks before arrival. System works if you’re patient.', helpful: 198, verified: false, type: 'mixed' },
    { id: 'sz5', author: 'CanyonOverlookSecret', source: 'The Dyrt', rating: 5, date: '2025-05', text: 'Canyon Overlook Trail at the east tunnel — completely empty at 7am. 360 degree views of the canyon and not a single other person. Meanwhile Angels Landing was a traffic jam. Highly recommend this as the alternative.', helpful: 312, verified: true, type: 'positive' },
  ],
  'blackwoods-acadia': [
    { id: 'ba1', author: 'CadillacSunrise', source: 'Campendium', rating: 5, date: '2025-06', text: 'Pink fog below us, first light of the day in the continental US. The sunrise reservation was worth every hassle. Drove back to camp for coffee and it still felt like a dream.', helpful: 267, verified: true, type: 'positive' },
    { id: 'ba2', author: 'CarriageRoadCyclist', source: 'The Dyrt', rating: 5, date: '2025-09', text: 'Biked 45 miles of carriage roads over three days. No cars, perfect surface, views of every lake and pond in the park. Best cycling infrastructure I’ve seen at any national park.', helpful: 245, verified: true, type: 'positive' },
    { id: 'ba3', author: 'SeptemberAcadia', source: 'Google', rating: 5, date: '2024-09', text: 'September: crowds gone, foliage just starting, temps in the 60s, lobster for $18 at the dockside shack. This is the move. July is a mistake.', helpful: 389, verified: true, type: 'positive' },
    { id: 'ba4', author: 'MaineFogWarning', source: 'Campendium', rating: 3, date: '2025-07', text: 'Fogged in for three straight days. Visibility 50 feet. Still hiked everything — the forest smells incredible in the mist. Just don’t come expecting clear views every day.', helpful: 134, verified: true, type: 'mixed' },
    { id: 'ba5', author: 'BeehiveViaFerrata', source: 'The Dyrt', rating: 5, date: '2025-08', text: 'Beehive Trail — iron rungs bolted into the cliff face, hands and feet climbing, 360 degree view at the top. 1.6 miles. Nobody talks about this trail and I cannot understand why.', helpful: 201, verified: false, type: 'positive' },
  ],
  'elkmont-smoky-mountains': [
    { id: 'em1', author: 'FireflyLottery', source: 'The Dyrt', rating: 5, date: '2025-05', text: 'Won the synchronous firefly lottery and the universe rewarded us. Hundreds of fireflies blinking in perfect unison across the meadow at 9:30pm. I’ve never seen anything like it and I’ve been camping for 30 years.', helpful: 445, verified: true, type: 'positive' },
    { id: 'em2', author: 'OctoberSmokeys', source: 'Campendium', rating: 5, date: '2024-10', text: 'Peak October foliage. Every tree a different color. Alum Cave Trail covered in yellow and orange. Crying in a parking lot kind of beautiful. Best camping trip of my life.', helpful: 378, verified: true, type: 'positive' },
    { id: 'em3', author: 'BearBoxNotOptional', source: 'Google', rating: 4, date: '2025-07', text: 'Bear came into camp at 3am and worked on our neighbor’s cooler because they left it outside. Follow the rules — the cooler was destroyed and the bear had to be relocated. Not worth it.', helpful: 267, verified: true, type: 'mixed' },
    { id: 'em4', author: 'LittleRiverA1', source: 'The Dyrt', rating: 5, date: '2025-08', text: 'Site A4 directly on the Little River. Fell asleep to the sound of the current every night. This is what camping should feel like.', helpful: 198, verified: true, type: 'positive' },
    { id: 'em5', author: 'ElkmontGhostTown', source: 'Campendium', rating: 5, date: '2024-06', text: 'Walked half a mile to the abandoned Elkmont historic district — 1920s vacation cabins rotting beautifully in the forest. Zero other visitors. One of the strangest and most atmospheric places I’ve found in any national park.', helpful: 156, verified: false, type: 'positive' },
  ],


  'assateague-island-oceanside': [
    { id: 'ai1', author: 'PonyWatcher99', source: 'Campendium', rating: 5, date: '2025-09', text: 'Woke up at 5am to three wild ponies standing outside our tent. Not staged, not a petting zoo — genuinely wild horses that have lived on this island for centuries. Nothing will ever top this for me.', helpful: 312, verified: true, type: 'positive' },
    { id: 'ai2', author: 'AtlanticSunrise', source: 'The Dyrt', rating: 5, date: '2025-05', text: 'East-facing beach means the most spectacular sunrise of my camping life. Coffee by the surf, nobody else around, watching the horizon turn pink and orange. Drove 4 hours and it was worth every minute.', helpful: 287, verified: true, type: 'positive' },
    { id: 'ai3', author: 'GreenheadSurvivor', source: 'Google', rating: 3, date: '2025-07', text: 'The ponies are magical but the greenhead flies in July are truly vicious. We’re talking biting insects that ignore DEET and go for exposed skin constantly. Go in September instead — we learned.', helpful: 198, verified: true, type: 'mixed' },
    { id: 'ai4', author: 'BaysideSekret', source: 'Campendium', rating: 4, date: '2025-06', text: 'Everyone books oceanside but the bayside sites have calm water perfect for kayaking, warmer temperatures, and actually more pony activity. Less dramatic but more enjoyable.', helpful: 145, verified: false, type: 'positive' },
    { id: 'ai5', author: 'FoodCrimeScene', source: 'The Dyrt', rating: 4, date: '2024-08', text: 'A pony got into our cooler in under 90 seconds. Soft-sided cooler — gone. Hard-sided cooler survived. The ponies are experienced thieves. They are not cute about it.', helpful: 267, verified: true, type: 'mixed' },
  ],
  'mazama-crater-lake': [
    { id: 'cl1', author: 'CraterConvert', source: 'Campendium', rating: 5, date: '2025-08', text: 'I’ve camped in 40 states. Crater Lake is the only place that made me actually stop the car and cry from sheer disbelief at what I was seeing. The color is not edited in photos. It actually looks like that.', helpful: 489, verified: true, type: 'positive' },
    { id: 'cl2', author: 'WizardIslandWorth', source: 'The Dyrt', rating: 5, date: '2025-07', text: 'Wizard Island boat tour — book this the SECOND reservations open. I tried same-day, 3 days out, nothing. Finally got lucky with a cancellation. Worth every dollar of the effort. Swim in the caldera.', helpful: 321, verified: true, type: 'positive' },
    { id: 'cl3', author: 'CleetWoodClimb', source: 'Google', rating: 4, date: '2025-08', text: 'The hike down to Cleetwood Cove is manageable. The hike back UP is legitimately hard — 700 feet of steep switchbacks in full sun. That said the swim in the lake is extraordinary and worth it.', helpful: 234, verified: true, type: 'mixed' },
    { id: 'cl4', author: 'RimDriveRev', source: 'Campendium', rating: 5, date: '2025-09', text: 'Drove Rim Drive counterclockwise at 5:30am before crowds. For 2 hours I had the most scenic road in America entirely to myself. Every overlook showing that impossible blue.', helpful: 198, verified: false, type: 'positive' },
    { id: 'cl5', author: 'SnowInJuly', source: 'Recreation.gov', rating: 4, date: '2024-07', text: 'Arrived July 5th and the north rim road was still partially closed from June snow. Check road conditions before you go — this park’s season is shorter than you think.', helpful: 167, verified: true, type: 'mixed' },
  ],
  'jumbo-rocks-joshua-tree': [
    { id: 'jt1', author: 'MilkyWayMoment', source: 'The Dyrt', rating: 5, date: '2025-02', text: 'I bought a DSLR specifically to photograph the Milky Way at Jumbo Rocks. New moon in February, no light pollution south of camp, and 5 hours of shooting. This campground changed my life.', helpful: 567, verified: true, type: 'positive' },
    { id: 'jt2', author: 'BoulderBedroom', source: 'Campendium', rating: 5, date: '2025-03', text: 'Site 28 has a massive boulder behind it that becomes your living room. Scrambled to the top for sunrise and watched the shadows of the Joshua trees stretch across the desert. Bring good shoes.', helpful: 389, verified: true, type: 'positive' },
    { id: 'jt3', author: 'NoWaterWarning', source: 'Google', rating: 3, date: '2025-04', text: 'This is not a suggestion: bring all your water. There is no water at Jumbo Rocks. We ran short on day 2 and had to drive to Twentynine Palms and back. Minimum 1 gallon per person per day.', helpful: 312, verified: true, type: 'mixed' },
    { id: 'jt4', author: 'ScorpionUV', source: 'The Dyrt', rating: 4, date: '2025-01', text: 'Bought a UV flashlight before the trip on advice of other campers. Found 3 scorpions around our campsite at night. They glow bright green. Not stung, but now I always check.', helpful: 278, verified: false, type: 'positive' },
    { id: 'jt5', author: 'ChollaSunset', source: 'Campendium', rating: 5, date: '2025-03', text: 'Drive the 6 miles to Cholla Cactus Garden at sunset. The backlit jumping cholla look like they’re on fire. It’s 15 minutes out of your way and the most bizarre beautiful thing you’ll see in the park.', helpful: 245, verified: true, type: 'positive' },
  ],
  'st-mary-glacier': [
    { id: 'sm1', author: 'GrizzlyMorning', source: 'Campendium', rating: 5, date: '2025-08', text: 'Grizzly bear 50 yards from our site at 7am. Just walking through, unbothered. Heart was pounding. This is what real wilderness camping feels like. Never felt more alive.', helpful: 423, verified: true, type: 'positive' },
    { id: 'sm2', author: 'SunRoadCry', source: 'The Dyrt', rating: 5, date: '2025-07', text: 'Going-to-the-Sun Road should not be legal. I had to pull over at every overlook. My wife said I was overreacting. Then she started crying too. Nothing prepares you.', helpful: 578, verified: true, type: 'positive' },
    { id: 'sm3', author: 'ReservationHell', source: 'Google', rating: 4, date: '2025-07', text: 'Getting here requires planning like a military operation: campground reservation 6 months out, vehicle permit for the road, Logan Pass parking reservation. Worth it but do your homework.', helpful: 312, verified: true, type: 'mixed' },
    { id: 'sm4', author: 'TwoMedicinSecret', source: 'Campendium', rating: 5, date: '2025-08', text: 'While everyone crowds Logan Pass, we went to Two Medicine Lake. Boat tour, wildflowers, zero crowds. Just as dramatic, half the people. Best kept secret in the park.', helpful: 234, verified: false, type: 'positive' },
    { id: 'sm5', author: 'ShortSeason', source: 'The Dyrt', rating: 4, date: '2024-06', text: 'Drove from Colorado to find Going-to-the-Sun still closed June 12th. Snow. Check road status obsessively before your trip. The park doesn’t fully open until late June some years.', helpful: 198, verified: true, type: 'mixed' },
  ],
  'big-meadows-shenandoah': [
    { id: 'bm1', author: 'MeadowDusk', source: 'The Dyrt', rating: 5, date: '2025-10', text: 'Seven deer in the meadow at sunset. Two fawns. An AT thru-hiker walked by and sat with us for an hour telling trail stories. This is exactly why I camp.', helpful: 445, verified: true, type: 'positive' },
    { id: 'bm2', author: 'FoliageFirst', source: 'Campendium', rating: 5, date: '2025-10', text: 'Mid-October peak color on Skyline Drive is the most beautiful thing I’ve seen in 20 years of East Coast camping. Every overlook is a painting. Every single one.', helpful: 398, verified: true, type: 'positive' },
    { id: 'bm3', author: 'DarkHollowMorning', source: 'Google', rating: 5, date: '2025-05', text: 'Dark Hollow Falls at 6:30am — completely alone, mist rising off the water, the sound of the cascade. 0.8 miles from camp. If you don’t do this you’ve wasted your Shenandoah trip.', helpful: 287, verified: true, type: 'positive' },
    { id: 'bm4', author: 'BearBoxMandatory', source: 'The Dyrt', rating: 4, date: '2025-08', text: 'Shenandoah bears are different from Smokies bears — they’re bolder and will approach camp. The food storage boxes are mandatory not optional. Followed the rules and had zero issues.', helpful: 198, verified: true, type: 'mixed' },
    { id: 'bm5', author: 'LimberLostMist', source: 'Campendium', rating: 5, date: '2025-09', text: 'The Limberlost Trail is a boardwalk through ancient hemlock forest. Nobody does it. We went at 7am in morning mist and it felt like another world. 1.3 miles and completely flat.', helpful: 234, verified: false, type: 'positive' },
  ],
}
...
export const campaignInsights: Record<string, {
  ...
  'gold-ranch-rv-verdi': { sentiment: 82, topPositives: ['75ft pull-throughs', 'Casino dining on-site', 'Pool and hot tub', 'Friendly staff', 'Sierra hiking trail'], topNegatives: ['I-80 noise on perimeter sites', 'Not wilderness camping', 'Some maintenance inconsistency'], campaignAngle: 'Full hookups, 75ft pull-throughs, casino dining, and Sierra hiking — 12 miles from Reno', targetAudience: 'Full-hookup RVers, big rig travelers, I-80 road trippers, Tahoe base campers', hashtags: ['#GoldRanchRV', '#VerdiNevada', '#RenoRVPark', '#I80Camping', '#CasinoRV'] },
    ...
    'south-campground-zion': { sentiment: 94, topPositives: ['Best campground location in Zion', 'First shuttle access', 'Canyon glow at sunset', 'Narrows access'], topNegatives: ['Sells out instantly', 'Summer heat extreme', '27ft rig limit'], campaignAngle: 'First shuttle, first at Angels Landing — the only campground that puts you ahead of the crowds', targetAudience: 'Hikers, national park enthusiasts, photographers, adventure families', hashtags: ['#ZionNP', 'AngelsLanding', '#TheNarrows', '#ZionCamping', '#UtahOutdoors'] },
  'blackwoods-acadia': { sentiment: 91, topPositives: ['Cadillac sunrise', 'Best cycling in any national park', 'September perfection', 'Beehive Trail'], topNegatives: ['Fog and rain common', 'Bar Harbor summer crowds', 'No hookups'], campaignAngle: 'First sunrise in America, best carriage road cycling, fresh lobster — Acadia is the Northeast at its finest', targetAudience: 'Cyclists, hikers, photographers, New England travelers, fall foliage seekers', hashtags: ['#AcadiaNP', '#CadillacMountain', '#MaineCamping', '#CarriageRoads', '#BarHarbor'] },
  'elkmont-smoky-mountains': { sentiment: 93, topPositives: ['Synchronous fireflies', 'October foliage peak', 'Little River sites', 'Free park entry'], topNegatives: ['Bear safety strict', 'Summer humidity', 'Books out instantly'], campaignAngle: 'Synchronous fireflies, peak fall color, Little River — the Smokies are America’s most-visited park for good reason', targetAudience: 'Families, hikers, wildlife watchers, fall foliage seekers, photographers', hashtags: ['#GreatSmokyMountains', '#SynchronousFireflies', '#SmokyMountains', '#TennesseeOutdoors', '#NationalParks'] },
    'assateague-island-oceanside': { sentiment: 91, topPositives: ['Wild ponies in camp', 'Atlantic beach camping', 'East-facing sunrise', 'Barrier island experience'], topNegatives: ['Biting insects in summer', 'Ponies steal food', 'No shade at oceanside'], campaignAngle: 'Wild horses walk through your campsite. Atlantic surf 200 feet away. The most unique camping experience on the East Coast.', targetAudience: 'Beach campers, wildlife watchers, East Coast road trippers, photographers, families', hashtags: ['#AssateagueIsland', '#WildPonies', '#ChincoteaguePonies', '#BeachCamping', '#EastCoastCamping'] },
  'mazama-crater-lake': { sentiment: 95, topPositives: ['Deepest bluest lake in US', 'Rim Drive views', 'Wizard Island boat tour', 'Dark sky at elevation'], topNegatives: ['Short season', 'Cleetwood Cove climb back up', 'Campground not on rim'], campaignAngle: "The most impossibly blue water you’ll ever see. Camp in the caldera of an ancient supervolcano.", targetAudience: 'Oregon road trippers, photographers, hikers, stargazers, national park collectors', hashtags: ['#CraterLake', '#CraterLakeNP', '#OregonCamping', '#WizardIsland', '#CraterLakeBlue'] },
  'jumbo-rocks-joshua-tree': { sentiment: 92, topPositives: ['Best dark sky in SoCal', 'Giant boulder campsites', 'Rock climbing mecca', 'Two desert ecosystems'], topNegatives: ['No water at camp', 'Extreme summer heat', 'Rattlesnakes and scorpions'], campaignAngle: 'Boulders the size of houses. The best Milky Way accessible by car in Southern California. A desert unlike any other.', targetAudience: 'Rock climbers, stargazers, photographers, desert lovers, Southern California weekenders', hashtags: ['#JoshuaTree', '#JoshuaTreeNP', '#JumboRocks', '#MilkyWayCamping', '#CaliforniaDesert'] },
  'st-mary-glacier': { sentiment: 93, topPositives: ['Going-to-the-Sun Road', 'Grizzly bear sightings', 'Most dramatic scenery in US', 'St. Mary Lake views'], topNegatives: ['Short season', 'Multiple permit layers required', 'Small RV limit'], campaignAngle: 'The most dramatic scenery in the lower 48. Drive the most beautiful road in America from your campground.', targetAudience: 'National park enthusiasts, photographers, hikers, wildlife watchers, road trippers', hashtags: ['#GlacierNP', '#GlacierNationalPark', '#GoingToTheSunRoad', '#MontanaCamping', '#GrizzlyCountry'] },
  'big-meadows-shenandoah': { sentiment: 90, topPositives: ['Best East Coast fall foliage', 'Deer every evening', 'Appalachian Trail access', 'Dark Hollow Falls nearby'], topNegatives: ['October weekends book instantly', 'Bears require strict food storage', '35mph speed limit throughout'], campaignAngle: 'Best fall foliage drive on the East Coast. Deer guaranteed at dusk. Appalachian Trail from your door.', targetAudience: 'East Coast campers, fall foliage seekers, hikers, families, Appalachian Trail hikers', hashtags: ['#Shenandoah', '#SkylineDrive', '#FallFoliage', '#VirginiaCamping', '#AppalachianTrail'] },
}
